...
import { IMG_CARD, imageUrl } from '../../core/images.js?v=202609211413';
import { emit, on } from '../../core/events.js?v=202609211413';
import { worldLots } from '../../data/world-lots.js?v=202609211413';
import { customLots, state } from '../../core/state.js?v=202609211413';
import {
  fetchSheetLots,
  getLots,
  sheetLots,
  sheetLotsLoaded,
  sheetWorldMeta,
} from '../../core/sheet-data.js?v=202609211413';
import { repositionTooltips } from '../../ui/tooltips.js?v=202609211413';
import { showMobileDotBar } from '../../ui/mobile-dot-bar.js?v=202609211413';
import { updateAllTokens } from '../characters/tokens.js?v=202609211413';
import { enterBuilding, exitBuilding } from '../buildings/building-view.js?v=202609211413';
import {
  calibWorldLots,
  updateCalibLog,
  updateCalibrating,
} from '../admin/calibration.js?v=202609211413';
import { renderAdminContent } from '../admin/admin-panel.js?v=202609211413';
import { getBuildingNrRange, groupLots, parseLotLabel } from './lot-helpers.js?v=202609211413';
import { mapC, mapIA } from './continent-map.js?v=202609211413';
...
/* "Neuer Ort": opens the empty new-topic form in the forum for exactly this
   ...
   (".../f51780-Newcrest.html"). plan_world hands the world to Blaze, who then
   suggests a fitting title and guides through creating it; after saving, the
   lot tool in the forum does the assignment.
   It cannot add new dots at new positions — their coordinates live in
   data/world-lots.js. */
