/* PROJEKT ATLAS - Kern-Logik. Wird in Etappe 3 in Module zerlegt. */
...
const worldLots={
  ...
  "Gibbi Point":[
    {nr:"Strassen",name:"Gibbi Point (Strassen)",x:60.7,y:45.4,outdoor:true},
    {nr:"Nr. 1",x:20,y:22.9},
    {nr:"Nr. 2",x:32.4,y:21.6},
    {nr:"Nr. 3",x:21.3,y:34.1},
    {nr:"Nr. 4",x:36.7,y:30.2},
    {nr:"Nr. 5",x:63.3,y:16.5},
    {nr:"Nr. 6",x:79.5,y:22},
    {nr:"Nr. 7",x:67.9,y:31.2},
    {nr:"Nr. 8",x:78.3,y:30},
    {nr:"Nr. 9",x:74.1,y:39.8},
    {nr:"Nr. 10",x:54,y:61.8},
    {nr:"Nr. 11",x:66.9,y:57.1},
    {nr:"Nr. 12",x:70.6,y:63.9},
    {nr:"Nr. 13",x:77.5,y:72.9},
  ],
  "Ondarion":[
  ...
  "Oasis Springs":[
    {nr:"Strassen",name:"Oasis Springs (Strassen)",x:40.5,y:60.6,outdoor:true},
    {nr:"Nr. 1",x:20.2,y:35.9},
    {nr:"Nr. 2",x:12.9,y:44.6},
    {nr:"Nr. 3",x:20,y:49.3},
    {nr:"Nr. 4",x:34.8,y:43.1},
    {nr:"Nr. 5",x:50.1,y:51.7},
    {nr:"Nr. 6",x:44,y:32.3},
    {nr:"Nr. 7",x:60.1,y:37.1},
    {nr:"Nr. 8",x:68.8,y:50.4},
    {nr:"Nr. 9",x:79,y:44.3},
    {nr:"Nr. 10",x:88.8,y:52.3},
    {nr:"Nr. 11",x:83.4,y:56.8},
    {nr:"Nr. 12",x:75.5,y:57.1},
    {nr:"Nr. 13",x:81.7,y:73.5},
    {nr:"Nr. 14",x:64.4,y:65.4},
    {nr:"Nr. 15",x:54.6,y:68.1},
    {nr:"Nr. 16",x:69.5,y:79.4},
    {nr:"Nr. 17",x:58.5,y:79.6},
    {nr:"Nr. 18",x:39.3,y:81.5},
    {nr:"Nr. 19",x:31.7,y:72.1},
    {nr:"Nr. 20",x:20.5,y:67},
    {nr:"Nr. 21",x:13.8,y:63.8},
  ],
  "Newcrest":[
  ...
  "Del Sol Valley":[
    {nr:"Strassen",name:"Del Sol Valley (Strassen)",x:50.7,y:56.2,outdoor:true},
    {nr:"Nr. 1",x:28.1,y:34.3},
    {nr:"Nr. 2",x:33.5,y:27.2},
    {nr:"Nr. 3",x:39.4,y:29.5},
    {nr:"Nr. 4",x:61.2,y:23},
    {nr:"Nr. 5",x:69.5,y:17.5},
    {nr:"Nr. 6",x:79.2,y:25.5},
    {nr:"Nr. 7",x:30.3,y:61.1},
    {nr:"Nr. 8",x:37.5,y:61.1},
    {nr:"Nr. 9",x:38.9,y:69},
    {nr:"Nr. 10",x:30.8,y:73},
    {nr:"Nr. 11",x:21.8,y:68.1},
  ],
  "Strangerville":[
  ...
  "Mt. Komorebi":[
    {nr:"Strassen",name:"Mt. Komorebi (Strassen)",x:43.8,y:66.6,outdoor:true},
    {nr:"Nr. 1",x:37.1,y:24.9},
    {nr:"Nr. 2",x:45.7,y:26.6},
    {nr:"Nr. 3",x:56,y:24.9},
    {nr:"Nr. 4",x:65,y:20.6},
    {nr:"Nr. 5",x:37.3,y:40},
    {nr:"Nr. 6",x:46.4,y:40.5},
    {nr:"Nr. 7",x:35.4,y:48.2},
    {nr:"Nr. 8",x:47.5,y:49.2},
    {nr:"Nr. 9",x:31.6,y:56.2},
    {nr:"Nr. 10",x:57.8,y:71.5},
    {nr:"Nr. 11",x:66.2,y:68.4},
    {nr:"Nr. 12",x:76.2,y:63.2},
    {nr:"Nr. 13",x:60.7,y:84.6},
    {nr:"Nr. 14",x:81.6,y:77},
  ],
  "Henford-on-Bagley":[
  ...
  "Copperdale":[
    {nr:"Strassen",name:"Copperdale (Strassen)",x:48.3,y:58.6,outdoor:true},
    {nr:"Nr. 1",x:28.9,y:34.9},
    {nr:"Nr. 2",x:18.1,y:46.4},
    {nr:"Nr. 3",x:34.3,y:44.1},
    {nr:"Nr. 4",x:23.5,y:53.4},
    {nr:"Nr. 5",x:21.5,y:62.2},
    {nr:"Nr. 6",x:66.7,y:60},
    {nr:"Nr. 7",x:76.2,y:59.4},
    {nr:"Nr. 8",x:82.1,y:65.1},
    {nr:"Nr. 9",x:53.6,y:79.3},
    {nr:"Nr. 10",x:64.7,y:84.7},
    {nr:"A",x:40.7,y:19.9},
    {nr:"B",x:47.1,y:16.4},
  ],
  "San Sequoia":[
    {nr:"Strassen",x:50.3,y:44,outdoor:true},
    {nr:"Nr. 1",x:14.8,y:12.6},
    {nr:"Nr. 2",x:15.6,y:23.2},
    {nr:"Nr. 3",x:28.7,y:28.4},
    {nr:"Nr. 4",x:36.3,y:33.8},
    {nr:"Nr. 5",x:72.7,y:8.9},
    {nr:"Nr. 6",x:68.5,y:27.9},
    {nr:"Nr. 7",x:89.2,y:19.8},
    {nr:"Nr. 8",x:83.3,y:32.3},
    {nr:"Nr. 9",x:41.2,y:68.1},
    {nr:"Nr. 10",x:50.3,y:69.4},
    {nr:"Nr. 11",x:66.4,y:76.3},
    {nr:"Nr. 12",x:58.2,y:90.1},
  ],
  // ── NEU: 7 Welten mit Koordinaten ──────────────────────────────────────
  "Chestnut Ridge":[
  ...
  "Nordhaven":[
    {nr:"Strassen",x:50,y:55.6,outdoor:true},
    {nr:"Nr. 1",x:17.6,y:46.2},
    {nr:"Nr. 2",x:24.2,y:38.8},
    {nr:"Nr. 3",x:22.8,y:26.4},
    {nr:"Nr. 4",x:33.8,y:43.5},
    {nr:"Nr. 5",x:38.1,y:21.2},
    {nr:"Nr. 6",x:42.4,y:32.3},
    {nr:"Nr. 7",x:70.7,y:43},
    {nr:"Nr. 8",x:65.9,y:56.3},
    {nr:"Nr. 9",x:74.4,y:60},
    {nr:"Nr. 10",x:82.1,y:56},
    {nr:"Nr. 11",x:69.6,y:71.9},
    {nr:"Nr. 12",x:79.2,y:72.6},
  ],
  "Granite Falls":[
