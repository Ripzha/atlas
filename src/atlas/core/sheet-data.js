...
import { emit } from './events.js?v=202609230614';
import { readCache, writeCache } from './cache.js?v=202609230614';
import { BASE } from '../config.js?v=202609230614';
import { worlds } from '../data/worlds.js?v=202609230614';
import { worldLots } from '../data/world-lots.js?v=202609230614';
import { customLots, hiddenLots, renamedLots } from './state.js?v=202609230614';
import { updateOtherworldPortalTokens } from '../features/otherworlds/portal.js?v=202609230614';
