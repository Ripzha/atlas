...
import { emit } from './events.js?v=202609201813';
import { readCache, writeCache } from './cache.js?v=202609201813';
import { BASE } from '../config.js?v=202609201813';
import { worlds } from '../data/worlds.js?v=202609201813';
import { worldLots } from '../data/world-lots.js?v=202609201813';
import { customLots, hiddenLots, renamedLots } from './state.js?v=202609201813';
import { updateOtherworldPortalTokens } from '../features/otherworlds/portal.js?v=202609201813';
