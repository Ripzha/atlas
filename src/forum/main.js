...
import { initLastSeenTracker } from './last-seen-tracker.js?v=202609201833';
import { initCharacterEditor } from './character-editor.js?v=202609201833';
import { initLotAssignment } from './lot-assignment.js?v=202609201833';
import { initEventPill } from './event-pill.js?v=202609201833';

const FEATURES = { initLastSeenTracker, initCharacterEditor, initLotAssignment, initEventPill };

const css = document.createElement('link');
css.rel = 'stylesheet';
css.href = new URL('../../styles/forum/forum.css?v=202609201833', import.meta.url).href;
